...
class Filter extends Component {
    ...
    submitHandler = (e) => {
        e.preventDefault()
        let { id, category, subcategory, title, price, tag, size, color } = this.state

        if (!id && !category && !subcategory && !title && !tag && !size && !color && !price) {
            alert("please provide any text")
            return
        }

        let arr = { id, category, subcategory, title, price, tag, size, color, subcategories: subcategoryData }
    ...
    render() {
        let { id, category, subcategory, title, color, size, price, tag } = this.state
        return (
